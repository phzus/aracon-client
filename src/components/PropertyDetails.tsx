        ...
        <div className="property-details-left ma:space-y-8">
          ...
          <div className="mobile-info-card ma:px-5 sm:ma:px-0">
            <div className="property-details-sticky ma:space-y-5">
              ...
              <div className="ma:space-y-3">
                <button
                  className="btn-primary ma:w-full ma:flex ma:items-center ma:justify-center ma:gap-2 ma:px-6 ma:py-4 ma:text-white ma:font-semibold ma:rounded-lg ma:cursor-pointer ma:transition-all ma:uppercase"
                >
                  <svg className="ma:w-5 ma:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="btn-whatsapp ma:w-full ma:flex ma:items-center ma:justify-center ma:gap-2 ma:px-6 ma:py-4 ma:text-white ma:font-semibold ma:rounded-lg ma:transition-all ma:cursor-pointer ma:uppercase"
                >
