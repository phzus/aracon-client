      ...
      <div className="property-details-layout">
        ...
        <div className="property-details-left ma:space-y-8">
          ...
          <div className="mobile-info-card">
            <div className="property-details-sticky ma:space-y-5">
              ...
              <div className="ma:space-y-3">
                <button
                  className="ma:w-full ma:flex ma:items-center ma:justify-center ma:gap-2 ma:px-6 ma:py-4 ma:text-white ma:font-semibold ma:rounded-lg ma:cursor-pointer ma:transition-colors ma:uppercase"
                  style={{ backgroundColor: 'var(--ma-brand-blue)' }}
                >
                  <svg className="ma:w-5 ma:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="ma:w-full ma:flex ma:items-center ma:justify-center ma:gap-2 ma:px-6 ma:py-4 ma:bg-green-500 hover:ma:bg-green-600 ma:text-white ma:font-semibold ma:rounded-lg ma:transition-colors ma:cursor-pointer ma:uppercase"
                >
        ...
        <div className="property-details-right">
          <div className="property-details-sticky ma:space-y-5">
            ...
            {/* CTA Buttons */}
            <div className="ma:space-y-3">
              {/* Agendar Visita Button - azul escuro primário */}
              <button
                className="ma:w-full ma:flex ma:items-center ma:justify-center ma:gap-2 ma:px-6 ma:py-4 ma:text-white ma:font-semibold ma:rounded-lg ma:cursor-pointer ma:transition-colors ma:uppercase"
                style={{ backgroundColor: 'var(--ma-brand-blue)' }}
              >
