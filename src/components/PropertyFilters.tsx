...
export function PropertyFiltersComponent({ filters, onFilterChange, cities }: PropertyFiltersProps) {
  ...
  const hasActiveFilters = filters.tipo || filters.cidade;
  ...
  return (
    <div className="ma:bg-white ma:rounded-xl ma:shadow-md ma:p-4 ma:mb-8">
      <div className="ma:flex ma:flex-wrap ma:items-center ma:gap-3">
        ...
        <div className="ma:w-full sm:ma:flex-1 ma:min-w-[200px]">
        ...
        {/* Filters Container for Mobile Side-by-Side */}
        <div className="ma:flex ma:gap-3 ma:w-full sm:ma:w-auto">
          {/* Type Filter */}
          <select
            value={filters.tipo || ''}
